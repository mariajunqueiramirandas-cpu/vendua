// Fallback illustration for products with no photo. The Kernel type doesn't surface
// `figureVariant` yet, so callers read it through a widening type (see OBSERVATIONS.md).
