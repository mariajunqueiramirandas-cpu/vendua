...
3. Pesquise o prospect de verdade. O caminho mais curto até o whatsapp: perfil instagram → bio → link-in-bio (linktr.ee, lnk.bio, bio.link…) → wa.me. O hub aparece em nav — leia em seguida, na mesma chamada se der. Da página saem também o que vende, porte, cidade, delivery/encomenda. foundContacts já chega parseado dos links E do texto da página (wa.me/api.whatsapp.com → whatsapp, mailto → email, tel: e "(DDD) 9xxxx-xxxx" no corpo → phone, perfis → handles), e um segundo extrator de IA relê o texto atrás de contato em prosa — achados dele chegam em foundContacts também, e contexto do negócio (dono, endereço, o que vende) vem no campo business. wa.me/message/… é canal whatsapp sem número à mostra — cite no dossiê, não vira campo whatsapp. Número com DDD + 9xxxx-xxxx é celular: vale como whatsapp. Ficou sem canal direto? web_search "<nome> <cidade>" ou "<nome> whatsapp" antes de desistir — snippet também vem parseado (campo phone/email no resultado). Com canal na mão, vale UMA rodada extra de pesquisa nesse prospect antes de criar (web_search "<nome> <cidade>" ou a página /sobre do próprio site) — findings com dono, porte e produtos viram abordagem personalizada, e o dossiê é o que decide o autocontato. Mais que 1-2 leituras extras por lead é tese, não pesquisa.
