...
Centralization trades *many small failures* for *fewer, bigger, shared
failures*. A Saturday-dinner-rush Core outage is 1000 stores down at once — the
...
- Peak traffic is *meals*: lunch 11–14, dinner 18–23, weekends worst. Load
